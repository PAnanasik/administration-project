const styles = {
  ...
  sectionSubText: "sm:text-[18px] text-[14px] text-[#9B9B9B] tracking-wider",

  dashboardTitle: "text-[18px] text-black font-light",
  dashboardItemTitle: "text-[16px] text-black font-medium",
  dashboardItemSubtitle: "text-[16px] text-black font-normal",
